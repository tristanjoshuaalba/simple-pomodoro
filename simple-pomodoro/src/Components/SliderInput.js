...
const SliderInput = ({ focusTime, restTime , statusLabel, phase}) => {
        if(statusLabel === true){ // FOCUS
            if(phase === 'focus'){
                return ( 
                <div className = 'center w-75' >

                    <div className = { selected } > Concentrate </div> 
                    ...
                    <div className = { unselected } > Relax </div> 
                ...
                return ( 
                <div className = 'center w-75' >
                    <div className =  { unselected } > Concentrate </div>  
                    ...
                    <div className = { selected } > Relax </div> 
